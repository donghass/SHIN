...
## 1. 웹쉘 또는 리버스쉘로 서버에서 AWS 인프라 정보 수집 (Reconnaissance)
...
```
![img.png](img/AWS서버침투withS3/img.png)
...
![img_6.png](img/AWS서버침투withS3/img_6.png)
...
```
![img_7.png](img/AWS서버침투withS3/img_7.png)
### 권한 설정
```bash
...
```bash
sh -i Book-Village.pem ubuntu@[퍼블릭IP]
```
